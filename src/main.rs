...
async fn perform_one_time_initialization(
    ...
    // Resolve datacenter endpoints (US/EU/JP) from license key prefix; env var overrides win
    config::apply_datacenter_endpoints(&license_key, &mut updated_config.new_relic);
