...
- Apache License 2.0 (`Apache-2.0`) — 148 crate references
...
- **aws-sdk-lambda 1.144.0** — `Apache-2.0` — <https://github.com/awslabs/aws-sdk-rust>
- **aws-sdk-secretsmanager 1.115.0** — `Apache-2.0` — <https://github.com/awslabs/aws-sdk-rust>
- **aws-sdk-ssm 1.122.0** — `Apache-2.0` — <https://github.com/awslabs/aws-sdk-rust>
- **aws-sdk-sts 1.114.0** — `Apache-2.0` — <https://github.com/awslabs/aws-sdk-rust>
...
- **aws-config 1.12.0** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
...
- **aws-runtime 1.9.2** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
...
- **aws-smithy-eventstream 0.61.2** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
- **aws-smithy-http-client 1.4.0** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
...
- **aws-smithy-runtime-api 1.16.0** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
- **aws-smithy-runtime 1.14.0** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
- **aws-smithy-schema 0.2.0** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
- **aws-smithy-types 1.6.3** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
- **aws-smithy-xml 0.62.0** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
- **aws-types 1.6.0** — `Apache-2.0` — <https://github.com/smithy-lang/smithy-rs>
...
- **serial_test 3.5.0** — `MIT` — <https://github.com/palfrey/serial_test/>
- **serial_test_derive 3.5.0** — `MIT` — <https://github.com/palfrey/serial_test/>
